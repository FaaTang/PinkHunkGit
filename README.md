...
Run **Pink Hunk Git: Update All Git Repositories** to `git pull` each Git repository VS Code / Cursor has detected. You can trigger it via:

- `Ctrl+T` (macOS: `Cmd+T`)
- The sync button in the Commit panel title bar
- Command Palette: **Pink Hunk Git: Update All Git Repositories**
