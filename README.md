...
- In the Changes group, per-repository ahead/behind counts after the branch name (`N↓` / `N↑`); click to pull that repo or open Push for it (multi-root workspaces supported)
